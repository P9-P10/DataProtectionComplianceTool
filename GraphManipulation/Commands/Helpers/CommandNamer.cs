...
public static class CommandNamer
{
    ...
    public const string SetAlias = "st";

    public const string ShowCommand = "show";
    public const string ShowAlias = "sh";
    ...
    public const string PurposeListOption = "--purposes";
    public const string PurposeListOptionAlias = "-ps";
